...
const Sidebar = ({ sidebarOpen, handleMenuItemClick, activeMenuItem, menuItems, setSidebarOpen }) => {
    return (
        <>
            ...
            <div
                className={`w-56 bg-gray-900 text-white fixed md:static h-screen z-50 transition-all duration-300 flex flex-col ${sidebarOpen ? 'left-0' : '-left-56 md:left-0'
                    }`}
            >
                ...
                <div className="border-t border-gray-800 px-5 py-4 flex items-center cursor-pointer mt-auto">
